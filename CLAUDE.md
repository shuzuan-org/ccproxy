...
> ⚠️ **2026-06-18 状态**：ATTEST_KEYS 已在 2.1.138 → 2.1.181 之间**轮换**（静态验证：旧 V1..V4 小端字节在 2.1.181 binary 中全部缺失，xxhash PRIME64 对照实验证明搜索法有效）。当前 cch.go 的 keys 对 ≥2.1.150 的 UA 算出的 cch 是**错的**。新 V1..V4 待抽出。详见 `mitm-analysis/cch-probe/FINDINGS-2.1.181.md`。
